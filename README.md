...
- Android Auto доступно только для пользователей с root доступом, требуется установить [дополнительный модуль](https://github.com/Pixel-Props/BetterKnownInstalled).
