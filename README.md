...
- Яндекс.Плюс для Android Auto, музыка скрытие рекламы включены всегда
...
- Реклама
- Скрытие ленты историй, предложений, подборок, товаров в карточках организаций
...
- Android Auto доступно только для пользователей с root доступом, требуется установить [дополнительный модуль(глобально)](https://github.com/Pixel-Props/BetterKnownInstalled). Так же через [LSPosed модуль](https://github.com/frknkrc44/HMA-OSS) индивидуально для Яндекс Карт.
